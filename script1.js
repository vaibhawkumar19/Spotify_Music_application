...
const makeAllPlays = ()=>{
    Array.from(document.getElementsByClassName('songItemPlay')).forEach((element)=>{
        element.classList.remove('fa-solid fa-3x fa-circle-play');
        element.classList.add('fa-solid fa-3x fa-circle-pause');
    })
}
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element)=>{
    element.addEventListener('click', (e)=>{ 
        ...
        e.target.classList.remove('fa-solid fa-3x fa-circle-pause');
        e.target.classList.add('fa-solid fa-3x fa-circle-play');
